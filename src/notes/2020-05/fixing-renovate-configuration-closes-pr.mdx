...
I [reached for help](https://github.com/renovatebot/config-help/issues/632) in the `renovatebot/config-help` repository and, after some investigation, Rhys Arkins suggested to change a bit the configuration. The assumption being that the mix of rules and `lockFileMaintenance` was causing some unexpected issues.
...
> But I recommend you don't combine major updates into that all updates.
